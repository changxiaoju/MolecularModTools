#todo, remove replicate part. use KDtree
import os
import time
import numpy as np
...
# ==================================================================================#
# Main code author = {Batuhan Yildirim and Hamish Galloway Brown}, https://github.com/by256/rdfpy/tree/master.
# Since cKDtree is unable to handle PBC, a replicated coordination is required as input. 
# An alternative approach is using "dr = position1 - position2\n dr = dr - np.rint(dr / box.length) * box.length",but it may be computationally expensive due to querying all atoms.
# Consideration of atom types is necessary before calculating RDF.
# ==================================================================================#
